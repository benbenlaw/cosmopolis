...
public class AsteroidBuildingStructures extends StructureFeature<JigsawConfiguration> {

    public AsteroidBuildingStructures() {

        super(JigsawConfiguration.CODEC, AsteroidBuildingStructures::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    private static boolean isFeatureChunk(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        return !context.chunkGenerator().hasFeatureChunkInRange(BuiltinStructureSets.OCEAN_MONUMENTS, context.seed(), chunkpos.x, chunkpos.z, 0);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!AsteroidBuildingStructures.isFeatureChunk(context)) {
        ...
        blockpos = blockpos.above(topLandY + randomNumber);
