...
public class AsteroidStructures extends StructureFeature<JigsawConfiguration> {

    public AsteroidStructures() {

        super(JigsawConfiguration.CODEC, AsteroidStructures::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!AsteroidStructures.isFeatureChunk(context)) {
