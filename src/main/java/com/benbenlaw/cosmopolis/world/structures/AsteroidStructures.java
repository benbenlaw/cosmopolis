...
public class AsteroidStructures extends Structure {

    // A custom codec that changes the size limit for our code_structure_sky_fan.json's config to not be capped at 7.
    // With this, we can have a structure with a size limit up to 30 if we want to have extremely long branches of pieces in the structure.
    public static final Codec<AsteroidStructures> CODEC = RecordCodecBuilder.<AsteroidStructures>mapCodec(instance ->
            instance.group(AsteroidStructures.settingsCodec(instance),
            ...
            ).apply(instance, AsteroidStructures::new)).codec();
    ...
    public AsteroidStructures(Structure.StructureSettings config,
    ...
    public @NotNull Optional<Structure.GenerationStub> findGenerationPoint(Structure.@NotNull GenerationContext context) {
        ...
        if (!AsteroidStructures.extraSpawningChecks(context)) {
