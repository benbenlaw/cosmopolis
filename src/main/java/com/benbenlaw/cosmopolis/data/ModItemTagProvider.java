...
public class ModItemTagProvider extends ItemTagsProvider {
    ...
    protected void addTags() {
        ...
        tag(ModTags.Items.ORGANIC_POWDER_FUNGUS_BLOCK_DROPS)
                .addTags(Tags.Items.MUSHROOMS)
                .add(Items.WARPED_FUNGUS)
                .add(Items.CRIMSON_FUNGUS);

        tag(ModTags.Items.ORGANIC_POWDER_FUNGUS_SAPLING_DROPS)
                .addTags(ItemTags.SAPLINGS)
                .add(Items.BAMBOO);

        tag(ModTags.Items.ORGANIC_POWDER_SEED_SAPLING_DROPS)
